...
python2.7 5_nucleotideFrequencies.py $fasta --region-size-minimum 1 --region-size-maximum 3 --verbose > $genome

#Calculate frequencies of nucleotides in chrM of sacCer2 genome
chrM="$output/chrM.nucleotide.frequencies.tab"
python2.7 5_nucleotideFrequencies.py $fasta --region-size-minimum 1 --region-size-maximum 3 --only-chrom chrM --verbose > $chrM

#Calculate frequencies of nucleotides in 2micron of sacCer2 genome 
plasmid="$output/2micron.nucleotide.frequencies.tab"
python2.7 5_nucleotideFrequencies.py $fasta --region-size-minimum 1 --region-size-maximum 3 --only-chrom 2micron --verbose > $plasmid
