...
parser.add_argument('-i', metavar='BED', help="R|'/path/to/Nucleotide-Frequencies/Ribonucleotides/FS1.coordinates.bed'")
parser.add_argument('-s', metavar='Reference', help="R|Subset of reference genome of interest (sacCer2, nuclear, chrM, etc.)")
