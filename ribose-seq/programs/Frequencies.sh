...
#############################################################################################################################
	...
	flankBed -i $coordinates -s -g /projects/home/agombolay3/data/repository/Ribose-seq-Project/ribose-seq/reference/sacCer2.bed -l 100 -r 0 > upstreamIntervals.txt
	flankBed -i $coordinates -s -g /projects/home/agombolay3/data/repository/Ribose-seq-Project/ribose-seq/reference/sacCer2.bed -l 0 -r 100 > downstreamIntervals.txt
