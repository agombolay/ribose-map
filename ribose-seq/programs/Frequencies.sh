...
#############################################################################################################################
	...
	#/projects/home/agombolay3/data/bin/bedtools2/bin/flankBed -i $coordinates -s -g $referenceBED -l 100 -r 0 > upstreamIntervals.txt
	#/projects/home/agombolay3/data/bin/bedtools2/bin/flankBed -i $coordinates -s -g $referenceBED -l 0 -r 100 > downstreamIntervals.txt
	
	/projects/home/agombolay3/bedtools2/bin/bedtools flank -i $coordinates -s -g $referenceBED -l 100 -r 0 > upstreamIntervals.txt
	/projects/home/agombolay3/bedtools2/bin/bedtools flank -i $coordinates -s -g $referenceBED -l 0 -r 100 > downstreamIntervals.txt
