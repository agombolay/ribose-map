...
**Distribution**: Creates bedgraph files to allow rNMP coordinates to be uploaded and visualized in genome browser of choice and plots per-nucleotide rNMP coverage
