...
2. **Coordinate Module** calculates single-nucleotide genomic coordinates of rNMPs based on aligned reads for any rNMP sequencing technique, including ribose-seq, emRiboSeq, RHII-HydEn-seq, Alk-HydEn-seq, and Pu-seq.  
