...
**Note**: If you have a BED file of single nucleotide coordinates that was not created using the Coordinate Module and would like to directly use Ribose-Map's Sequence, Distribution, or Hotspot Modules, create a folder with the path below and save the file in this folder:
