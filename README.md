...
Note: If you have a list of single nucleotide coordinates that were not created using the Coordinate Module and would like to use the Sequence or Distribution Modules, you will need to first create a folder with the path shown below:
