...
5. **Distribution**: Creates BedGraph files of per-nucleotide rNMP coverage to be visualized in a genome browser and plots per-nucleotide rNMP coverage for each genomic unit of reference genome and normalizes for sequencing depth
