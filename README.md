...
**Note**: If you have a BED file of single-nucleotide genomic coordinates and want to directly use Ribose-Map's Sequence, Distribution, or Hotspot Modules, create a folder with the filepath below, save the file in this folder, and create a config file.
