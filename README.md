...
* **Distribution**: Creates bedgraph files of per-nucleotide rNMP coverage to be visualized in any genome browser and plots the per-nucleotide rNMP coverage (%) for each chromosome and separated by DNA strand (+/-)
