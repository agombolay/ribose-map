...
* Create bedgraph files of data to be uploaded and visualized in any genome browser of choice and also plot the per-nucleotide rNMP coverage (given as percentage to allow comparison between libraries of different sequencing depth)  
