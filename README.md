...
**Note**: If you have a BED file of single-nucleotide genomic coordinates and would like to directly use Ribose-Map's Sequence, Distribution, or Hotspot Modules, first create a folder with the path below and then save the file in this folder:
