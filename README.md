...
* Create bedgraph files of data to be uploaded and visualized in any genome browser of choice and then plot the per-nucleotide rNMP coverage for each chromosome (given as percentage to allow comparison among libraries of different sequencing depth)  
