...
Ribose-Map is the only standardized bioinformatics toolkit that can process and analyze any type of high-throughput rNMP sequencing data (i.e., data generated from any organism and using any rNMP sequencing technique: ribose-seq, emRiboSeq, Alk-HydEn-seq, RHII-HydEn-seq, or Pu-seq). In addition, Ribose-Map can also be used to analyze any type of single-nucleotide sequencing data. 
