...
<object data="https://github.com/agombolay/ribose-map/blob/master/logo.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="https://github.com/agombolay/ribose-map/blob/master/logo.pdf">
