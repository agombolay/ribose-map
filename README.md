...
2. Please following [these instructions](https://docs.conda.io/en/latest/miniconda.html) to install MiniConda for your operating system and make sure to add MiniConda to your path
