...
The **Coordinate Module** calculates single-nucleotide chromosomal coordinates of rNMPs based on the positions of the aligned reads. The Coordinate Module can calculate the coordinates for any of the current sequencing techniques.  
