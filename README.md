...
The **Coordinate Module** calculates single-nucleotide chromosomal coordinates of rNMPs based on the aligned reads. The coordinates can be calculated for any rNMP-seq technique, including ribose-seq, emRiboSeq, Alk/RHII-HydEn-seq, or Pu-seq.  
