...
The **Coordinate Module** calculates single-nucleotide chromosomal coordinates of rNMPs from the aligned reads and based on the particular rNMP sequencing technique used during library preparation.  
