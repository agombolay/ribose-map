...
**Distribution**: Creates bedgraph files to allow rNMP coordinates to be uploaded and visualized in a genome browser and plots per-nucleotide rNMP coverage
