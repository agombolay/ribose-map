...
Ribose-Map is the only standardized bioinformatics toolkit that can process and analyze any type of high-throughput rNMP sequencing data (i.e., data generated using ribose-seq, emRiboSeq, Alk-HydEn-seq, RHII-HydEn-seq, or Pu-seq). In addition to rNMP sequencing data, Ribose-Map's Composition, Sequence, Distribution, and Hotspot Modules can also be used to analyze any type of single-nucleotide sequencing data. 
