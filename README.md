...
Press ENTER when prompted; when asked for the installation path for Miniconda3, type yes and press ENTER to use your HOME folder as the site of installation or enter the path to an alternative folder where you would rather have it installed; when asked if you want to add Miniconda3 to your .bashrc, type yes and press ENTER.
