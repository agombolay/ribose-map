 ...
 * Compared to BED files, bigBed files are a faster way to display large data sets in the UCSC Genome Browser as a graph [(more)] (http://genome.ucsc.edu/goldenPath/help/bigBed.html)
