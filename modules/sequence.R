...
####################################################################################################################################################################
		myplot <- ggplot(data, aes(x = position)) + theme_minimal() + xlab("Position relative to rNMP") + ylab("Normalized Frequency") +
				 ...
				 theme(axis.line = element_line(size = 1), axis.title=element_text(color = "black", size = 30)), axis.ticks = element_line(colour = "black"),
				 axis.text = element_text(color = "black", size = 30), axis.ticks = element_line(colour = "black"), plot.margin = unit(c(.5, .5, .5, .5), "cm"))
